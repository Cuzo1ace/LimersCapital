  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5 mb-5">
        ...
        <StatCard icon="🪂" label="Projected Airdrop" value={`${fmtNum(Math.floor(projectedAirdrop))} $LIMER`} sub="Based on current LP" color="#00ffa3" />
      </div>

      {/* Streak Shields */}
      <div className="rounded-xl border border-border p-5 mb-7 flex items-center gap-5 flex-wrap"
        ...
        <div className="flex-1 min-w-[180px]">
          <div className="font-body font-bold text-[.88rem] text-txt mb-0.5">
      ...
      {/* LP vs XP */}
      <div className="rounded-xl border border-border p-6 mb-7 grid grid-cols-1 md:grid-cols-2 gap-6" style={{ background: 'var(--color-card)' }}>
        <div>
          <h3 className="font-body font-bold text-[.88rem] text-sea mb-2">⚡ XP — Learning Progress</h3>
        ...
        <div>
          <h3 className="font-body font-bold text-[.88rem] text-[#2D9B56] mb-2">🍋 LP — Economic Value</h3>
      ...
      {/* How to Earn */}
      <h2 className="font-headline text-[.92rem] font-bold uppercase tracking-widest text-txt mb-4">How to Earn LP</h2>
      ...
      {/* Referral */}
      <div className="rounded-xl border border-sea/20 p-6 mb-7 flex items-center gap-5 flex-wrap"
        style={{ background: 'linear-gradient(135deg, rgba(0,255,163,.04), rgba(45,155,86,.04))' }}>
        <div className="text-3xl">🤝</div>
        <div className="flex-1 min-w-[200px]">
          <div className="font-body font-bold text-[.92rem] text-txt mb-1">Refer Friends — Earn 200 LP Each</div>
        ...
        <div className="flex flex-col gap-2 min-w-[240px]">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={shareOnX}
              ...
              style={{ background: '#00ffa3', color: '#0d0e10' }}>
              𝕏 Share
            </button>
          </div>
        </div>
      ...
      {/* LP History */}
      <h2 className="font-headline text-[.92rem] font-bold uppercase tracking-widest text-txt mb-4">Recent LP Activity</h2>
      ...
      {/* Leaderboard */}
      <h2 className="font-headline text-[.92rem] font-bold uppercase tracking-widest text-txt mb-4">Community Leaderboard</h2>
...
function StatCard({ icon, label, value, sub, color }) {
  return (
    <div className="rounded-[14px] p-5 border border-border" style={{ background: 'var(--color-card)' }}>
      ...
      <div className="font-headline text-[1.4rem] font-black" style={{ color }}>{value}</div>
